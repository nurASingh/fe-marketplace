...
export default {
  ...
  computed: {
    trackingUrl: function () {
      const lastTransaction = this.$store.getters[APP_CONSTANTS.KEY_ASSET_LAST_TRANSACTION](this.assetHash)
      return this.$store.getters[APP_CONSTANTS.KEY_MY_ITEM](lastTransaction.txId)
    },
